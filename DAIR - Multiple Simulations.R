...
write.csv2(GAM_rmse,"GAM_rmse.CSV"  )
write.csv2(RF_rmse,"RF_rmse.CSV")
write.csv2(MARS_rmse,"MARS_rmse.CSV")
...
gam_rmse_1$X = NULL
gam_rmse_2 = read.csv2("gam_rmse 2.csv",row.names = NULL)
gam_rmse_2$X = NULL
gam_rmse_100 = rbind(gam_rmse_1,gam_rmse_2)

mars_rmse_1 = read.csv2("mars_rmse 1.csv",row.names = NULL)
mars_rmse_1$X = NULL
mars_rmse_2 = read.csv2("mars_rmse 2.csv",row.names = NULL)
mars_rmse_2$X = NULL
mars_rmse_100 = rbind(mars_rmse_1,mars_rmse_2)

rf_rmse_1 = read.csv2("rf_rmse 1.csv",row.names = NULL)
rf_rmse_1$X = NULL
rf_rmse_2 = read.csv2("rf_rmse 2.csv",row.names = NULL)
rf_rmse_2$X = NULL
rf_rmse_100 = rbind(rf_rmse_1,rf_rmse_2)
